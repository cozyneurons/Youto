...
const incidents: Incident[] = [
  ...
  { id: 5, title: 'The In-Video Sponsors', category: 'distraction', categoryLabel: 'Known distraction', duration: 'Brief but annoying', severity: 'Medium severity', summary: 'A predictable temptation required a skip-button workaround.', issue: 'The user knew the ad was annoying but still had to sit through a 2-minute VPN pitch.', action: 'Block exposure completely, read the AI summary, and skip the fluff.', system: 'Automated content restriction', icon: '🔇', color: '#b99cff' },
